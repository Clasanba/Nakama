      ...
      <footer className="  py-3 text-center  footer ">
        <div className="item-footer ">
          <a
            ...
            target="_blank"
          >
            <i className="fa-brands fa-square-facebook me-3 fs-2 text-with-color "></i>
          </a>
          <a href="https://www.instagram.com/comunidadnakama/" target="_blank">
            <i className="fa-brands fa-instagram me-3 fs-2 text-with-color"></i>
          </a>
          <a href="https://twitter.com/Nakama_2022 " target="_blank">
            <i className="fa-brands fa-twitter me-3 fs-2 text-with-color"></i>
          </a>
          <a href="mailto:comunidadnakama@gmail.com" target="_blank">
            <i className="fa-regular fa-envelope me-3 fs-2 text-with-color"></i>
          </a>
        </div>
      </footer>
    </>
